...
public class MainActivityTest {
    ...
    public void assertGetCircumference() {
        ...
        onView(withId(R.id.btn_calculate_circumfence)).check(matches(isDisplayed()));
        onView(withId(R.id.btn_calculate_circumfence)).perform(click());
        onView(withId(R.id.txResult)).check(matches(isDisplayed()));
        onView(withId(R.id.txResult)).check(matches(withText(dummyCircumference)));
    }
    @Test
    public void assertGetSurfaceArea() {
        ...
        onView(withId(R.id.txResult)).check(matches(isDisplayed()));
        onView(withId(R.id.txResult)).check(matches(withText(dummySurfaceArea)));
    }
    @Test
    public void assertGetVolume() {
        ...
        onView(withId(R.id.txResult)).check(matches(isDisplayed()));
        onView(withId(R.id.txResult)).check(matches(withText(dummyVolume)));
    }
